...
Original file is located at
    https://colab.research.google.com/drive/1kbuvR_FLHwrx_V3ysYq-4DfuALNdhWec
"""
...
model = joblib.load("salary_prediction_rfr_model (3).pk1")
encoder = joblib.load("label_encoder_Salary (1).pk1")
...
df = pd.DataFrame({
    ...
    "Select your education":[job_title],
